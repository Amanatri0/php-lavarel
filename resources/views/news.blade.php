                            ...
                            <form id="create_form" action="{{ url('news') }}" role="form" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <label class="required">{{ __('accessible_to_member_level') }}</label>
                                            <select id="accessible_to_member_level" name="accessible_to_member_level"
                                ...
                                <table aria-describedby="mydesc" id='table' data-toggle="table"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" data-field="accessible_to_member_level">{{ __('accessible_to_member_level') }}</th>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-4 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label class="required">{{ __('accessible_to_member_level') }}</label>
                                        <select id="edi_accessible_to_member_level" name="accessible_to_member_level"
                                            class="form-control" required>
                                            @foreach ($planList as $row)
                                                <option value="{{ $row->id }}">{{ $row->name }}
                                                </option>
