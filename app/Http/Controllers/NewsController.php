...
class NewsController extends Controller
{
    ...
    public function index()
    {
        ...
        try {
            ...
            $planList = DB::table('plans')->get();
            $locationList = Location::get();
            $userList = User::select('id', 'name')->where('status', 1)->where('role', '!=', 0)->get();
            return view('news', compact('languageList', 'categoryList', 'tagList', 'locationList', 'userList', 'planList'));
        } catch (Exception $e) {
    ...
    public function show(Request $request)
    {
        ...
        $rows = $sql->get()->map(function ($row) {
            ...
            $planList = DB::table('plans')->get()->toArray();
            $planList = array_column($planList, 'name', 'id');
            return [
                'id' => $row->id,
                ...
                'accessible_to_member_level' => '<span class="badge badge-info">' . $planList[$row->accessible_to_member_level] . '</span>',
    ...
    public function store(Request $request)
    {
        ...
        $news->accessible_to_member_level = $request->accessible_to_member_level ?? 1;
